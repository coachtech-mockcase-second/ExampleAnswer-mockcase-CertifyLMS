...
- [ ] 担当資格を持つコーチが当該資格の教材管理画面(Part / Chapter / Section / 演習問題 / 教材内画像 / 出題分野マスタ)を開くと正常に表示され、それぞれの作成・編集・削除・公開/非公開・並び替え・画像アップロード等の操作が認可で弾かれず実行できる
- [ ] 担当資格を持たないコーチは他資格の教材管理画面・操作にアクセスできず、管理者は全資格の教材管理を従来どおり操作できる(本修正で担当外資格まで開放されておらず、管理者の正常系も壊れていない)
