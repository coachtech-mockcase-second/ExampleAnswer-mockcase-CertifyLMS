    ...
    public function configure()
    {
        return $this->afterCreating(function ($course) {
            ...
            $course->lessons()->createMany(
                \App\Models\Lesson::factory()->count(rand(3, 8))->make()->toArray()
            );

            // レビューを作成（ユニーク制約を考慮）
            $students = User::where("role", "student")->inRandomOrder()->limit(rand(5, 15))->get();
...
class CourseSeeder extends Seeder
{
    public function run(): void
    {
        Course::factory(20)->create()->each(function ($course) {
            $course->tags()->attach(Tag::inRandomOrder()->limit(3)->get());
