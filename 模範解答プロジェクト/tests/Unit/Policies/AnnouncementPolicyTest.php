...
class AnnouncementPolicyTest extends TestCase
{
    ...
    public function test_admin_can_view_create(): void
    {
        ...
        $this->assertTrue($admin->can('viewAny', Announcement::class));
    ...
    public function test_coach_cannot(): void
    {
        ...
        $this->assertFalse($coach->can('viewAny', Announcement::class));
        $this->assertFalse($coach->can('create', Announcement::class));
    ...
    public function test_student_cannot(): void
    {
        ...
        $this->assertFalse($student->can('viewAny', Announcement::class));
        $this->assertFalse($student->can('create', Announcement::class));
