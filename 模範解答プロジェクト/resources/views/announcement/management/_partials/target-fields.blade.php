...
<x-form.fieldset legend="配信対象">
    <div class="space-y-3" data-announcement-target-fields>
        ...
        <div
            data-announcement-target-panel="{{ AnnouncementTargetType::Certification->value }}"
            @class([
                'pl-2 hidden' => $selectedType !== AnnouncementTargetType::Certification->value,
                'pl-2' => $selectedType === AnnouncementTargetType::Certification->value,
            ])
        >
            <x-form.select
        ...
        <div
            data-announcement-target-panel="{{ AnnouncementTargetType::User->value }}"
            @class([
                'pl-2 hidden' => $selectedType !== AnnouncementTargetType::User->value,
                'pl-2' => $selectedType === AnnouncementTargetType::User->value,
            ])
        >
            <x-form.select
                name="target_user_id"
