<x-nav.sidebar>
    ...
    <x-nav.section title="運用" :routes="['admin.users.index', 'admin.enrollments.index', 'admin.plans.index', 'admin.meeting-quota-plans.index', 'admin.certifications.index', 'admin.certification-categories.index']" />
