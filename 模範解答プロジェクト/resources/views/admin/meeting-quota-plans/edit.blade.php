...
@section('content')
    <x-breadcrumb :items="[
        ...
        ['label' => $plan->name, 'href' => route('admin.meeting-quota-plans.show', $plan)],
        ['label' => '編集'],
    ]" />
    ...
    <x-card class="mt-6" padding="lg" shadow="sm">
        <form method="POST" action="{{ route('admin.meeting-quota-plans.update', $plan) }}" class="space-y-5">
            @csrf
            @method('PATCH')
            ...
            <div class="flex items-center justify-end gap-2 pt-2">
                <x-link-button href="{{ route('admin.meeting-quota-plans.show', $plan) }}" variant="ghost">キャンセル</x-link-button>
