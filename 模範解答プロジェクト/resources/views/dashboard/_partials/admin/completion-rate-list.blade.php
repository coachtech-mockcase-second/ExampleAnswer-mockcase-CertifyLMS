...
<x-card padding="md">
    ...
    @else
        <ul class="flex flex-col">
            @foreach ($rows as $row)
                @php
                    ...
                    $useWarning = $rate < 0.7;
                @endphp
                <li class="grid items-center gap-3 py-2.5 border-b border-[var(--border-subtle)] last:border-b-0"
        ...
        <p class="text-[11px] text-ink-500 mt-3 pt-2.5 border-t border-[var(--border-subtle)] flex items-start gap-1.5">
